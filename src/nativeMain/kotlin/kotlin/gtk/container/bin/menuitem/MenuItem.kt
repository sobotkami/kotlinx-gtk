package kotlin.gtk.container.bin.menuitem
...
class MenuItem internal constructor(
	...
	var useUnderLine: Boolean
		get() = Boolean.from(
			gtk_menu_item_get_use_underline(menuItemPointer)
		)
	...
	var reserveIndicator: Boolean
		get() = Boolean.from(gtk_menu_item_get_reserve_indicator(menuItemPointer))
