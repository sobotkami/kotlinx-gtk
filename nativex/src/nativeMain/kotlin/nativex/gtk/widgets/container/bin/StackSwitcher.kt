...
import nativex.gtk.widgets.container.Stack.Companion.wrap
 ...
 */
class StackSwitcher(val stackSwitcherPointer: CPointer<GtkStackSwitcher>) : Bin(stackSwitcherPointer.reinterpret()) {
